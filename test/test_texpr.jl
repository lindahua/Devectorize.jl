...
@test isa(ex, TRef1D)
@test ex.host == tvar(:a)
@test ex.rgn == TInterval(2, symend)
@test ex == tref(:(a[2:end]))

ex = texpr(:(a[i0:end]))
@test isa(ex, TRef1D)
@test ex.host == tvar(:a)
@test ex.rgn == TInterval(:i0, symend)
@test ex == tref(:(a[i0:end]))
...
@test isa(ex, TRefCol)
@test ex.host == tvar(:a)
@test ex.rrgn == TInterval(2, symend)
@test ex.icol == 5
@test ex == tref(:(a[2:end, 5]))

ex = texpr(:(a[i0:end, 5]))
@test isa(ex, TRefCol)
@test ex.host == tvar(:a)
@test ex.rrgn == TInterval(:i0, symend)
@test ex.icol == 5
@test ex == tref(:(a[i0:end, 5]))
...
@test ex.host == tvar(:a)
@test ex.irow == 6
@test ex.crgn == TInterval(2, symend)
@test ex == tref(:(a[6, 2:end]))

ex = texpr(:(a[6, i0:end]))
@test isa(ex, TRefRow)
@test ex.host == tvar(:a)
@test ex.irow == 6
@test ex.crgn == TInterval(:i0, symend)
@test ex == tref(:(a[6, i0:end]))
...
@test ex.host == tvar(:a)
@test ex.rrgn == TColon()
@test ex.crgn == TInterval(:j0, symend)
@test ex == tref(:(a[:, j0:end]))
...
ex = texpr(:(a[i0:end, 2:end]))
@test isa(ex, TRef2D)
@test ex.host == tvar(:a)
@test ex.rrgn == TInterval(:i0, symend)
@test ex.crgn == TInterval(2, symend)
@test ex == tref(:(a[i0:end, 2:end]))

ex = texpr(:(a[i0:end, j0:end]))
@test isa(ex, TRef2D)
@test ex.host == tvar(:a)
@test ex.rrgn == TInterval(:i0, symend)
@test ex.crgn == TInterval(:j0, symend)
@test ex == tref(:(a[i0:end, j0:end]))

ex = texpr(:(a[i0:end, 3:7]))
@test isa(ex, TRef2D)
@test ex.host == tvar(:a)
@test ex.rrgn == TInterval(:i0, symend)
@test ex.crgn == TInterval(3, 7)
@test ex == tref(:(a[i0:end, 3:7]))

ex = texpr(:(a[i0:end, j0:7]))
@test isa(ex, TRef2D)
@test ex.host == tvar(:a)
@test ex.rrgn == TInterval(:i0, symend)
@test ex.crgn == TInterval(:j0, 7)
@test ex == tref(:(a[i0:end, j0:7]))

ex = texpr(:(a[i0:end, 3:j1]))
@test isa(ex, TRef2D)
@test ex.host == tvar(:a)
@test ex.rrgn == TInterval(:i0, symend)
@test ex.crgn == TInterval(3, :j1)
@test ex == tref(:(a[i0:end, 3:j1]))

ex = texpr(:(a[i0:end, j0:j1]))
@test isa(ex, TRef2D)
@test ex.host == tvar(:a)
@test ex.rrgn == TInterval(:i0, symend)
@test ex.crgn == TInterval(:j0, :j1)
@test ex == tref(:(a[i0:end, j0:j1]))
...
ex = texpr(:(a[i0:i1, 2:end]))
@test isa(ex, TRef2D)
@test ex.host == tvar(:a)
@test ex.rrgn == TInterval(:i0, :i1)
@test ex.crgn == TInterval(2, symend)
@test ex == tref(:(a[i0:i1, 2:end]))

ex = texpr(:(a[i0:i1, j0:end]))
@test isa(ex, TRef2D)
@test ex.host == tvar(:a)
@test ex.rrgn == TInterval(:i0, :i1)
@test ex.crgn == TInterval(:j0, symend)
@test ex == tref(:(a[i0:i1, j0:end]))
