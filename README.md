...
To keep it always updated, you may have to switch DeExpr to the ``master`` branch, and ``git pull`` the latest commits. 
...
To inspect the code generated by *DeExpr*, you can use the ``@inspect_devec`` macro:
